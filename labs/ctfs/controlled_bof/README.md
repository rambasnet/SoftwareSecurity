# Corrupt Specific Variable (Controlled BOF)
...
4. Note that the program takes user input from standard input and processes it in a way that can lead to a buffer overflow.
...
8. Provide detailed steps of your exploitation process, including how you identified the vulnerability, how you crafted your input, and how you used gdb/peda to analyze the program's memory layout. Use screenshots or terminal outputs to support your explanation.
