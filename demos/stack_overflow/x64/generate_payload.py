...
def main():
    ...
    parser.add_argument(
        "GDB_SHIFT", help="Offset (int) the GDB shifting address to lower address...")
    ...
    # stack is shigted higher in GDB due to its own environment variables, args, etc.
    GDB_SHIFT_COMPENSATION = int(args.GDB_SHIFT)
